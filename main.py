...
def send_telegram_message(checking_result, tgm_token, chat_id, logger):
...
def check_work(dvmn_token, tgm_token, chat_id, logger):
    ...
    while True:
        try:
            ...
            if result["status"] == "timeout":
                ...
                send_telegram_message(result, tgm_token, chat_id, logger)
...
def main():
    ...
    check_work(dvmn_token, tgm_token, chat_id, logger)
